...
**검증 (맥, 포트 8791)** — 세로 최대 **952 / 상한 994** (모든 인터랙션 전개 + 11장 세 버튼 상태 전부),
가로 넘침 0, 콘솔 에러·404 0, MathJax 오류 0·원시 TeX 잔존 0, 노트 16/16,
도식 4개 배율 1.00·잘림 0·라벨 겹침 0, 교과서 값 `pdftotext` 원문 대조 일치, 반례 수치 Python 검산 일치.
