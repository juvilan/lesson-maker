...
**확정된 것**: 교과서 84~95쪽을 **4차시(03~06)**로 분할. 설계 근거와 차시별 메모는
`docs/plans/2026-08-26-III-2-경향성과예측-차시분할.md` (커밋 `b861db1`).

| 차시 | 파일 | 교과서 | 상태 |
|---|---|---|---|
| ③ | `슬라이드_III-2-03_확률로예측하기.html` | 84~86 | 미착수 |
| ④ | `슬라이드_III-2-04_조건이겹칠때.html` | 87~89 | 미착수 |
| ⑤ | `슬라이드_III-2-05_산점도와추세선.html` | 90~92 | 미착수 |
| ⑥ | `슬라이드_III-2-06_예측값과오차.html` | 93~95 | 미착수 |

학습지는 덱이 끝난 차시부터 3쪽 구조로 붙입니다.

### 이어받는 세션이 알아야 할 것

- **번호를 03부터 시작한 이유** — 구판 `슬라이드_III-2-01_자료분석과예측.html`·
  `슬라이드_III-2-02_경향성과예측.html`이 절 단위로 01·02를 쓰고 있습니다.
  **삭제는 사용자 판단 사항이라 그대로 뒀습니다.** 지우지 마세요.
